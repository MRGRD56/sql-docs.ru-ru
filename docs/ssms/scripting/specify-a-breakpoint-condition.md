...
description: Сведения о том, как установить условие точки останова для управления тем, выполняет ли отладчик действие точки останова при попадании в точку останова и достижении числа попаданий.
