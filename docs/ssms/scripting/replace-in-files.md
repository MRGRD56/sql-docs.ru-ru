...
description: Сведения о том, как использовать функцию "Заменить в файлах" в окне "Поиск и замена", чтобы найти в тексте набора файлов строку или выражение и изменить некоторый или весь найденный текст.
