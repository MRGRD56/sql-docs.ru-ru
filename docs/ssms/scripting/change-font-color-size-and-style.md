...
description: Сведения о том, как изменить цвет, размер и начертание шрифта для редакторов SQL Server Management Studio. Цвет может отличаться для различных типов текста (таких как комментарии и инструкции).
