...
| Общедоступная версия расширения "Импорт SQL Server" | Объявлено о выпуске общедоступной версии расширения "Импорт SQL Server". Его функции больше не находятся в предварительной версии. Это расширение упрощает импорт файлов CSV и TXT. Дополнительные сведения о расширении см. в [этой статье](./extensions/sql-server-import-extension.md). |
...
12 августа 2020 г. &nbsp; / &nbsp; версия: 1.21.0
...
| На панель действий добавлен значок учетной записи Azure | Теперь пользователи могут легко увидеть, где можно выполнить вход в Azure |
...
| [Усовершенствования расширения машинного обучения](./extensions/machine-learning-extension.md) | Теперь поддерживается Управляемый экземпляр SQL Azure. |
...
| Устраненные ошибки и проблемы | Полный список исправлений см. на странице [ошибок и проблем в GitHub](https://github.com/microsoft/azuredatastudio/issues?q=is%3Aissue+milestone%3A%22June+2020+Release%22+is%3Aclosed). |
| &nbsp; | &nbsp; |

## <a name="may-2020-hotfix"></a>Май 2020 г. (исправление)

27 мая 2020 г. &nbsp; / &nbsp; Версия: 1.18.1

&nbsp;

| Change | Сведения |
| :----- | :------ |
| Исправление ошибки 10538 — настраиваемое сочетание клавиш для команды "Выполнить текущий запрос" перестало работать правильно. | [10538](https://github.com/microsoft/azuredatastudio/issues/10538)  |
| Исправление ошибки 10537 — не удалось открыть новые или существующие файлы SQL в версии 1.18. | [10537](https://github.com/microsoft/azuredatastudio/issues/10537)  |
| &nbsp; | &nbsp; |

## <a name="may-2020"></a>Май 2020 г.

20 мая 2020 г. &nbsp; / &nbsp; Версия: 1.18.0
...
| Расширение сообщества: Query Editor Boost | Query Editor Boost — это расширение с открытым кодом, позволяющее повысить удобство работы с редактором запросов Azure Data Studio для пользователей, которые часто пишут запросы. &bull; &nbsp; Сохранение текущего запроса как фрагмента кода <br/>&bull; &nbsp; Переключение баз данных с помощью клавиш CTRL+U <br/> &bull; &nbsp; Создание запроса по шаблону <br/> &bull; &nbsp; Полный список усовершенствований см. [здесь](https://github.com/dzsquared/query-editor-boost) |
...
| Расширение DACPAC теперь поддерживает Azure AD. | 
...
| Обновление SQL Server Profiler | Расширение профиля SQL Server обновлено для включения новых функций, таких как следующие. <br/> &bull; &nbsp; Фильтрация по имени базы данных <br/> &bull; &nbsp; Поддержка копирования и вставки <br/> &bull; &nbsp; Сохранение и загрузка фильтра <br/>Полный список улучшений для расширения SQL Server Profiler см. [здесь](https://github.com/microsoft/azuredatastudio/issues?utf8=%E2%9C%93&q=is%3Aissue+is%3Aclosed+milestone%3A%22July+2019+Release%22+label%3A%22Area%3A+SQL+Profiler%22+).  |
...
| Улучшения сравнения схем | &bull; &nbsp; Добавлены параметры исключения и включения <br/>&bull; &nbsp; Функция "Сформировать скрипт" открывает скрипт после его создания <br/>&bull; &nbsp; Удалены двойные полосы прокрутки  <br/>&bull; &nbsp; Усовершенствования форматирования и макета <br/>&bull; &nbsp; Полный список изменений см. [здесь](https://github.com/microsoft/azuredatastudio/issues?q=is%3Aissue+milestone%3A%22June+2019+Release%22+label%3A%22Area%3A+Schema+Compare%22+is%3Aclosed)|
...
| Усовершенствования записных книжек SQL | &bull; &nbsp; Теперь пользователи могут использовать собственные установки Python 3 или Anaconda в записных книжках <br/>&bull; &nbsp; Несколько исправлений стабильности, а также доводочные и заключительные исправления <br/> &bull; &nbsp; Полный список усовершенствований см. [здесь](https://github.com/microsoft/azuredatastudio/issues?q=is%3Aissue+milestone%3A%22June+2019+Release%22+is%3Aclosed+label%3A%22Area%3A+Notebooks%22)|
...
- Расширения средства администрирования баз данных для Windows
    ...
    - Ошибки при запуске серверов с некоторыми типами подключений (например, Azure AD).
- Записные книжки
...
| Change | Сведения |
| :----- | :------ |
| Добавлен пакет расширения **Пакет администрирования для SQL Server**. | Это упрощает установку расширений SQL Server, связанных с администрированием. В том числе:<br/>&bull; &nbsp; [Агент SQL Server](./extensions/sql-server-agent-extension.md)<br/>&bull; &nbsp; [SQL Server Profiler](./extensions/sql-server-profiler-extension.md)<br/>&bull; &nbsp; [Импорт SQL Server](./extensions/sql-server-import-extension.md) |
