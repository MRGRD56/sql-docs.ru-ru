---
title: Установка распределенного воспроизведения
...
Установите компоненты распределенного воспроизведения [!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] с помощью мастера установки [!INCLUDE[ssnoversion](../../includes/ssnoversion-md.md)] . При планировании расположения установленных компонентов примите во внимание следующее.  
...
> [!NOTE]  
>  Чтобы удалить или изменить компоненты распределенного воспроизведения, воспользуйтесь окном **Программы и компоненты** Windows на **Панели управления**. Выберите [!INCLUDE[ssnoversion](../../includes/ssnoversion-md.md)] в окне **Удаление или изменение программы** и нажмите кнопку **Удалить** , чтобы открыть мастер установки [!INCLUDE[ssnoversion](../../includes/ssnoversion-md.md)] . На странице **Выбор компонентов** укажите компоненты программы распределенного воспроизведения, которые нужно удалить.  
...
1.  Чтобы начать установку компонентов распределенного воспроизведения, запустите мастер установки [!INCLUDE[ssnoversion](../../includes/ssnoversion-md.md)] .  
...
5.  На странице **Файлы поддержки программы установки** щелкните **Установить** , чтобы установить или обновить файлы поддержки программы установки для [!INCLUDE[ssnoversion](../../includes/ssnoversion-md.md)].  
...
9. После завершения нажмите кнопку **Далее**.  
