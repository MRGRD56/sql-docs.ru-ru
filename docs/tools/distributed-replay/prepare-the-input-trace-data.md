...
description: Прежде чем начинать распределенное воспроизведение с помощью компонента распределенного воспроизведения SQL Server, подготовьте входные данные трассировки, инициировав этап предварительной обработки.
ms.prod: sql
