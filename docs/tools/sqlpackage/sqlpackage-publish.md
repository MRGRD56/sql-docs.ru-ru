---
title: Публикация SqlPackage
description: Узнайте, как автоматизировать задачи разработки баз данных с помощью публикации SqlPackage.exe. Ознакомьтесь с примерами и параметрами публикации, свойствами и переменными SQLCMD.
ms.prod: sql
...
## <a name="parameters-for-the-publish-action"></a>Параметры действия публикации
