...
description: Узнайте о том, как интерфейс пользователя помощника по настройке ядра СУБД используется для настройки базы данных, управления сеансами настройки и отображения рекомендаций по настройке.
ms.prod: sql
