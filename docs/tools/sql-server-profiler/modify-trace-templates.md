...
description: Узнайте, как изменить шаблоны трассировки в SQL Server Profiler. Добавляйте и удаляйте классы событий и столбцы данных, а также изменяйте фильтры.
ms.prod: sql
