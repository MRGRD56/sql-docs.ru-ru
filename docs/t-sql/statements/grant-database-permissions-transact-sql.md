...
|CREATE ANY EXTERNAL LIBRARY <br /> **Применимо к**: [!INCLUDE [sssql17-md](../../includes/sssql17-md.md)].|CONTROL|CONTROL SERVER |
...
|EXECUTE EXTERNAL SCRIPT <br /> **Применимо к**: [!INCLUDE[sssql19-md](../../includes/sssql19-md.md)].|EXECUTE ANY EXTERNAL SCRIPT|CONTROL SERVER|
