...
Алгоритмы MD2, MD4, MD5, SHA и SHA1 отмечены как нерекомендуемые в [!INCLUDE[sssql16-md](../../includes/sssql16-md.md)]. В версиях, предшествующих [!INCLUDE[sssql16-md](../../includes/sssql16-md.md)], самозаверяющий сертификат создается с помощью SHA1. Начиная с [!INCLUDE[ssSQL17](../../includes/sssql17-md.md)] самозаверяющий сертификат создается с помощью SHA2_256.
