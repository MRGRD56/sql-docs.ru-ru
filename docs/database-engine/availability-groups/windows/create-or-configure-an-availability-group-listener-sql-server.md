...
1.  Создайте прослушиватель, используя одно из следующих средств:  
    ...
    -   **Использование диспетчера отказоустойчивого кластера WSFC.**  
        ...
        3.  Добавление зависимости в ресурс группы доступности WSFC.  
         ...
         Дополнительные сведения о диалоговых окнах и вкладках диспетчера отказоустойчивости кластеров см. в разделе [Пользовательский интерфейс: оснастка "Диспетчер отказоустойчивости кластеров"](/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc772502(v=ws.11)).  
  
    -   **С помощью Windows PowerShell для отказоустойчивых кластеров.**  
  
        1.  Используйте командлет [Add-ClusterResource](/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/ee460983(v=technet.10)) , чтобы создать ресурсы сетевого имени и IP-адреса.  
