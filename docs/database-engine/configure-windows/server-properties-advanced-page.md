...
description: Изучите дополнительные параметры сервера SQL Server. Узнайте о параметрах FILESTREAM, различных пороговых значениях, вариантах обновления полнотекстового поиска и других параметрах.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
 ...
 **Порог курсора**  
 ...
 Если установить пороговое значение равным -1, все наборы ключей формируются синхронно. Это выгодно для небольших наборов курсоров. Если установить пороговое значение равным 0, все наборы ключей курсора формируются асинхронно. В случае присвоения других значений, оптимизатор запросов сравнивает количество ожидаемых строк в наборе курсоров и строит набор ключей асинхронно, если ожидаемое количество превышает установленный порог. Дополнительные сведения см. в статье [Настройка параметра конфигурации сервера cursor threshold](../../database-engine/configure-windows/configure-the-cursor-threshold-server-configuration-option.md).  
