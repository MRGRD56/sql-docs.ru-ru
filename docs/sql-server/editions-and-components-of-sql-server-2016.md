...
<sup>2</sup> применяется к [!INCLUDE[sssql15-md](../includes/sssql16-md.md)] SP1 в процессе формирования общей контактной зоны возможностей программирования (CPSA) между выпусками. 
...
|Параллелизм секционированных таблиц|Да|Да <sup>2</sup>|Да <sup>2</sup>|Да <sup>2</sup>|Да <sup>2</sup>|  
...
<sup>1</sup> применяется к [!INCLUDE[sssql15-md](../includes/sssql16-md.md)] SP1 в процессе формирования общей контактной зоны возможностей программирования (CPSA) между выпусками.      
