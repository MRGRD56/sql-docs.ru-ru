...
-   [Обновление поддерживаемых версий и выпусков](../../../database-engine/install-windows/supported-version-and-edition-upgrades.md). Убедитесь в том, что текущая версия операционной системы Windows позволяет обновить используемую версию [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] до нужной версии [!INCLUDE[ssnoversion](../../../includes/ssnoversion-md.md)]. Например, невозможно напрямую обновить экземпляр отказоустойчивого кластера SQL Server 2005 до версии [!INCLUDE [sssql14-md](../../../includes/sssql14-md.md)] или обновить экземпляр отказоустойчивого кластера, запущенный в [!INCLUDE[winxpsvr-md](../../../includes/winxpsvr-md.md)].  
...
7.  На странице "Выбор экземпляра" укажите экземпляр [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)], который необходимо обновить. **Чтобы продолжить, нажмите кнопку "Далее"** .  
...
1.  Выполните перечисленные выше шаги, чтобы обновить кластер.  
