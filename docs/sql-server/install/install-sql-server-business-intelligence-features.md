---
title: Установка компонентов бизнес-аналитики
description: В этой статье приводятся ссылки на сведения об установке компонентов SQL Server, которые входят в состав платформы бизнес-аналитики Майкрософт.
...
-   [Установка служб Analysis Services](/analysis-services/instances/install-windows/install-analysis-services)  
  
-   [Установка служб Analysis Services в режиме Power Pivot](/analysis-services/instances/install-windows/install-analysis-services-in-power-pivot-mode)  
...
> [!NOTE]
> SQL Server Data Tools (SSDT) не входят в состав SQL Server 2016. [Скачайте SQL Server Data Tools](../../ssdt/download-sql-server-data-tools-ssdt.md).
