---
title: Включаемые файлы документации по SQL Server
description: Описание включаемых файлов SQL Server для управления версиями и области применения.
ms.custom: ''
ms.date: 01/19/2019
ms.prod: sql
ms.reviewer: ''
