...
## <a name="encryption-at-rest-utilities-on-big-data-cluster-bdc"></a>Служебные программы для шифрования неактивных данных в кластере больших данных

В этом разделе приводится ряд записных книжек, полезных для управления функциями шифрования неактивных данных в кластере больших данных.

|Имя |Описание |
|---|---|
|SOP0124 — перечисление ключей для шифрования неактивных данных|Используйте эту записную книжку для получения списка всех ключей HDFS.|
|SOP0128 — включение зон шифрования HDFS в кластерах больших данных|Используйте эту записную книжку для включения зон шифрования HDFS при обновлении версии накопительного пакета обновления 6 или более ранней до версии 8. Не требуется для новых развертываний накопительного пакета обновления 8 или более поздней версии или при обновлении до накопительного пакета обновления 9.|
|SOP0125 — удаление ключа для шифрования неактивных данных|Используйте эту записную книжку для удаления ключей зоны шифрования HDFS. __Будьте осторожны!__|
|SOP0126 — ключи резервного копирования для шифрования неактивных данных|Используйте эту записную книжку для резервного копирования ключей зоны шифрования HDFS.|
|SOP0127 — восстановление ключей для шифрования неактивных данных|Используйте эту записную книжку для восстановления ключей зоны шифрования HDFS.|
