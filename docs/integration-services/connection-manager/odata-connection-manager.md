...
|-|-|-|
|Проверка активности (Keep Alive)|Неверно|Значение заголовка проверки активности при отправке веб-запроса.|
|Максимальный размер полученного сообщения|4 ТБ|Максимальный размер полученного сообщения в байтах при отправке веб-запроса.|
|Число повторных попыток|5|Число повторных попыток при отправке веб-запроса.|
|Повторная попытка перехода в спящий режим|100|Время ожидания в миллисекундах перед повторной попыткой при отправке веб-запроса.|
|Время ожидания|600|Время ожидания в секундах при отправке веб-запроса.|
