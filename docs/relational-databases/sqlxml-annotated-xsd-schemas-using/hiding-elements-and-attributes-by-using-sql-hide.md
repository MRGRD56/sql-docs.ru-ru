...
description: 'Узнайте, как использовать аннотацию SQL: hide для скрытия элементов и атрибутов при выполнении запроса XPath к схеме XSD.'
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
