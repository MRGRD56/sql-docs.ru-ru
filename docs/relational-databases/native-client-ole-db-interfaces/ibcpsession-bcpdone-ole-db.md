---
description: 'IBCPSession:: BCPDone (поставщик собственного клиента OLE DB)'
...
ms.openlocfilehash: c9dc5ab4add384621d0dd0d642b63d4f365f550a
ms.sourcegitcommit: 0310fdb22916df013eef86fee44e660dbf39ad21
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/20/2021
ms.locfileid: "104749384"
---
...
## <a name="return-code-values"></a>Значения кода возврата  
 ...
 E_UNEXPECTED  
 Непредвиденный вызов метода. Например, перед вызовом этого метода не был вызван метод **BCPInit** .  
...
```  
 ...
 Образец устанавливает подключение к базе данных master.  
  
 Во время работы образца в каталоге проекта создается файл outfile.dat. Файл outfile.dat содержит данные, скопированные из таблицы в собственном (двоичном) режиме.  
