...
Сведения об XML-индексах см. в разделах [Обзор XML-индексов](../relational-databases/xml/xml-indexes-sql-server.md) и [Выборочные XML-индексы (SXI)](../relational-databases/xml/selective-xml-indexes-sxi.md).
...
```  
 ...
 ![Схема плана выполнения для этого запроса, показывающая, что оптимизатор запросов применяет оператор SORT для результирующего набора в порядке, указываемом предложением ORDER BY.](../relational-databases/media/indexsort1.gif)
...
```  
 ...
 ![Схема плана выполнения, показывающая, что оператор SORT исключен и используется вновь созданный некластеризованный индекс.](../relational-databases/media/insertsort2.gif)
...
### <a name="clustered-index-architecture"></a>Архитектура кластеризованного индекса  
 ...
 ![Схема, изображающая структуру кластеризованного индекса для одной секции.](../relational-databases/media/bokind2.gif)  
...
![Схема, изображающая структуру некластеризованного индекса, состоящего из одной секции.](../relational-databases/media/bokind1a.gif)  
...
### <a name="configuring-the-hash-index-bucket-count"></a><a name="configuring_bucket_count"></a> Настройка числа контейнеров хэш-индекса
...
### <a name="declaration-considerations"></a><a name="h3-b2-declaration-limitations"></a> Вопросы, связанные с обновлением  
...
##  <a name="memory-optimized-nonclustered-index-design-guidelines"></a><a name="inmem_nonclustered_index"></a> Рекомендации по проектированию некластеризованных индексов, оптимизированных для памяти 
...
[Повышение производительности с помощью индексированных представлений SQL Server 2008](/previous-versions/sql/sql-server-2008/dd171921(v=sql.100))  
