---
description: Поля диагностических записей для возвращающих табличные значения параметров
title: Поля записей диагностики параметров Table-Valued | Документация Майкрософт
ms.custom: ''
ms.date: 03/04/2017
ms.prod: sql
