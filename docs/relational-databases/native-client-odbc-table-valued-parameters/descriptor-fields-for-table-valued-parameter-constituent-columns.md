---
description: Поля дескриптора для столбцов, содержащих параметры, возвращающие табличные значения
title: Поле дескриптора для параметра Table-Valued
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
