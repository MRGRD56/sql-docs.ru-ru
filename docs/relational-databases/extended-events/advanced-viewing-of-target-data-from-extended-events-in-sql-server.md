...
description: Используйте дополнительные возможности среды SQL Server Management Studio для подробного просмотра целевых данных из расширенных событий. Можно просматривать, экспортировать и обрабатывать данные.
ms.date: 05/24/2019
ms.prod: sql
...
### <a name="b4-view-xel-with-sysfn_xe_file_target_read_file-function"></a>Б.4. Просмотр XEL-файла с помощью функции sys.fn_xe_file_target_read_file
...
![Снимок экрана: панель инструментов с выбранным элементом "Группирование" и диалоговое окно "Группирование".](../../relational-databases/extended-events/media/xevents-ssms-ui53-grouping.png)
...
![Снимок экрана: панель инструментов с выбранным элементом "Агрегирование" и диалоговое окно "Агрегирование".](../../relational-databases/extended-events/media/xevents-ssms-ui51-aggregdialogcount.png)

После агрегирования данные отображаются в новом виде, как показано далее.

![Снимок экрана с добавленным значением COUNT.](../../relational-databases/extended-events/media/xevents-ssms-ui52-aggregnewdisplay.png)
...
[Командлет PowerShell Read-SQLXEvent](https://www.powershellgallery.com/packages/SqlServer), выпущен в июле 2019 г.