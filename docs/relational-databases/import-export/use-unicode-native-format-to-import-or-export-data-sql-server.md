...
description: Использование собственного формата Юникода для массовой передачи данных между экземплярами SQL Server, позволяющее исключить преобразование типов данных в символьный формат и из него.
ms.custom: ''
ms.date: 09/30/2016
ms.prod: sql
