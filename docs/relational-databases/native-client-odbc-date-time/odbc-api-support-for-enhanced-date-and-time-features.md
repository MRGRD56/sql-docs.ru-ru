---
description: Поддержка API-интерфейса ODBC для улучшенных функций даты и времени
title: API ODBC для даты и времени
ms.custom: ''
ms.date: 12/18/2019
ms.prod: sql
...
ms.openlocfilehash: 211b092414e348cec4336abcabeabfb3f3b57611
ms.sourcegitcommit: 0310fdb22916df013eef86fee44e660dbf39ad21
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/20/2021
ms.locfileid: "104748204"
---
...
-   [SQLSpecialColumns](../../relational-databases/native-client-odbc-api/sqlspecialcolumns.md)  
 ...
 Следующие API-интерфейсы массового копирования поддерживают улучшенную функциональность даты и времени:  
