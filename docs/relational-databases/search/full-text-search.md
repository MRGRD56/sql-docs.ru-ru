...
##  <a name="compare-full-text-search-queries-to-the-like-predicate"></a><a name="like"></a> Сравнение предиката LIKE и запросов полнотекстового поиска
...
##  <a name="full-text-search-architecture"></a><a name="architecture"></a> Архитектура полнотекстового поиска
...
###  <a name="full-text-querying-process"></a><a name="querying"></a> Обработка полнотекстовых запросов  
