---
description: Наборы строк и SQL Server курсоры (поставщик собственного клиента OLE DB)
title: Наборы строк и SQL Server курсоры (поставщик собственного клиента OLE DB)
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.openlocfilehash: c708772b66c1adaf7d5216c60c9120583d0cea0d
ms.sourcegitcommit: 0310fdb22916df013eef86fee44e660dbf39ad21
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/20/2021
ms.locfileid: "104753574"
---
# <a name="rowsets-and-sql-server-cursors-native-client-ole-db-provider"></a>Наборы строк и SQL Server курсоры (поставщик собственного клиента OLE DB)
