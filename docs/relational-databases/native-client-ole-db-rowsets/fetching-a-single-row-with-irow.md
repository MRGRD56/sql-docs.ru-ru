---
description: Получение одной строки с помощью IRow (поставщик собственного клиента OLE DB)
title: Получение одной строки с помощью IRow (поставщик собственного клиента OLE DB) | Документация Майкрософт
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
