...
description: Применение сжатия данных строк и страниц, а также columnstore и архивного сжатия columnstore с помощью SQL Server и Базы данных SQL Azure.
ms.custom: ''
ms.date: 02/11/2021
ms.prod: sql
...
ms.locfileid: "100525202"
---
# <a name="data-compression"></a>Сжатие данных

[!INCLUDE [sql-asdb-asdbmi](../../includes/applies-to-version/sql-asdb-asdbmi.md)]

[!INCLUDE[ssnoversion](../../includes/ssnoversion-md.md)], [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)] и [!INCLUDE [sssdsmifull-md](../../includes/sssdsmifull-md.md)] поддерживают сжатие строк и страниц для таблиц и индексов rowstore, а также поддерживают columnstore и архивное сжатие columnstore для таблиц и индексов columnstore.  
...
## <a name="row-and-page-compression"></a>Сжатие строк и страниц
...
-   Таблицы, для которых в [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] был реализован формат хранения vardecimal, сохраняют эту настройку и после обновления. К таблице, в которой присутствует формат хранения vardecimal, можно применить сжатие строк. Однако, поскольку сжатие строк является надмножеством формата хранения vardecimal, причин для сохранения данного формата нет. Для десятичных значений не происходит никакого дополнительного сжатия при сочетании формата хранения vardecimal и сжатия строк. Сжатие страниц можно применить к таблице, в которой присутствует формат хранения vardecimal, однако для столбцов данного формата дополнительного сжатия, скорее всего, не произойдет.  
    ...
    > [!NOTE]  
    > Все поддерживаемые версии [!INCLUDE[ssnoversion](../../includes/ssnoversion-md.md)] поддерживает формат хранения vardecimal, однако сжатие данных достигает тех же целей, поэтому данный формат является устаревшим. [!INCLUDE[ssNoteDepFutureAvoid](../../includes/ssnotedepfutureavoid-md.md)]  
  
## <a name="columnstore-and-columnstore-archive-compression"></a>Columnstore и архивное сжатие Columnstore  
...
## <a name="impact-on-partitioned-tables-and-indexes"></a>Влияние на секционированные таблицы и индексы
...
## <a name="impact-on-other-sql-server-components"></a>Влияние на другие компоненты SQL Server
