...
description: Узнайте, как оптимизатор запросов использует статистику о столбцах в таблицах, оптимизированная для памяти, для создания планов запросов, которые повышают производительность запросов для выполняющаяся в памяти OLTP.
ms.custom: ''
ms.date: 10/23/2016
ms.prod: sql
