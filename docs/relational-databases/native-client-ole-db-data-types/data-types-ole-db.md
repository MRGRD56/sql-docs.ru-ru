---
description: Типы данных SQL Server Native Client (OLE DB)
title: Типы данных (поставщик собственного клиента OLE DB) | Документация Майкрософт
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "104748434"
---
# <a name="sql-server-native-client-data-types-ole-db"></a>Типы данных SQL Server Native Client (OLE DB)
