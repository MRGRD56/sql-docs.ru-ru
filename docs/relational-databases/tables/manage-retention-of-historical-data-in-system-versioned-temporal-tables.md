...
> [!NOTE]
> Подход с использованием политики хранения темпоральных журналов может применяться к [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)] с SQL Server 2017 начиная с CTP 1.3.
