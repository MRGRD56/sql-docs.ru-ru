---
description: Поддержка потоковой передачи выходных параметров больших двоичных объектов в SQL Server Native Client
title: Поддержка потоковой передачи для выходных параметров больших двоичных объектов (поставщик собственного клиента OLE DB)
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
ms.openlocfilehash: 7c0a26d5e7b682bbc64173b7add0661a122c17dc
ms.sourcegitcommit: 0310fdb22916df013eef86fee44e660dbf39ad21
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/20/2021
ms.locfileid: "104749474"
---
# <a name="streaming-support-for-blob-output-parameters-in-sql-server-native-client"></a>Поддержка потоковой передачи выходных параметров больших двоичных объектов в SQL Server Native Client
[!INCLUDE[SQL Server Azure SQL Database Synapse Analytics PDW ](../../includes/applies-to-version/sql-asdb-asdbmi-asa-pdw.md)]
 ...
 Выходные параметры могут быть заблокированы в методе IMultipleResults::GetResult при получении возвращаемого значения DB_E_OBJECTOPEN. Участнику следует проверить наличие ожидающих параметров больших двоичных объектов и либо полностью прочитать их, либо освободить их.  
