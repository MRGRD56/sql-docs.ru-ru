...
description: Сведения о том, как добавить задачу резервного копирования в план обслуживания в SQL Server с помощью задачи "Резервное копирование базы данных".
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
