---
title: Исполнение запросов XPath (SQLXML)
description: Узнайте, как выполнить запрос XPath к схеме сопоставления с помощью управляемых классов SQLXML.
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "107491780"
---
# <a name="executing-xpath-queries-sqlxml-managed-classes"></a>Выполнение запросов XPath (управляемые классы SQLXML)
