...
description: Просмотрите пример, показывающий, что SQL Server не поддерживает создание XML-схем, которые ограничивают смешанный тип простым содержимым.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
