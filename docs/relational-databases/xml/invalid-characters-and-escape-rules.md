...
description: Узнайте, как обрабатываются недопустимые символы XML с помощью предложения FOR XML, и ознакомьтесь с правилами экранирования для символов, недопустимых в XML-именах.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
