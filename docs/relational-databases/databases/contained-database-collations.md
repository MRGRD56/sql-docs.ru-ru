...
description: Узнайте, как работают параметры сортировки в автономных и неавтономных базах данных. См. проблемы, которые могут возникать при перекрестных сеансах между автономными и неавтономными контекстами.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
