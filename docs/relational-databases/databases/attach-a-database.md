...
description: Узнайте, как на SQL Server присоединить базу данных с помощью SQL Server Management Studio или Transact-SQL. Эту способ позволяет копировать, перемещать и обновлять базу данных.
ms.custom: ''
ms.date: 10/24/2016
ms.prod: sql
...
###  <a name="is-attach-the-best-choice"></a><a name="Recommendations"></a> Для чего использовать присоединение?  
