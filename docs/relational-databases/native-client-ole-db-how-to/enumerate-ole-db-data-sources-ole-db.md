---
description: Перечисление SQL Server Native Client OLE DB источников данных (OLE DB)
title: Перечислить OLE DB источники данных (поставщик собственного клиента OLE DB) | Документация Майкрософт
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
