...
ms.openlocfilehash: 19c1b0d2b5534cef3d928ee7a761671e102738e2
ms.sourcegitcommit: 0310fdb22916df013eef86fee44e660dbf39ad21
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/20/2021
ms.locfileid: "104736135"
---
...
## <a name="example"></a>Пример  
 ...
 Скомпилируйте листинг кода (C++) с библиотеками odbc32.lib и user32.lib. Убедитесь, что переменная среды INCLUDE включает каталог, содержащий файл sqlncli.h.  
