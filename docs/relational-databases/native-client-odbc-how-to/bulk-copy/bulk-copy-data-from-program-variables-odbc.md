---
description: Обеспечение массового копирования данных из переменных приложения (ODBC)
...
ms.openlocfilehash: 24328e6e7f7b91773055659aa94ea7fa7550c4c4
ms.sourcegitcommit: 0310fdb22916df013eef86fee44e660dbf39ad21
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/20/2021
ms.locfileid: "104744184"
---
...
4.  Вызовите [bcp_init](../../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-init.md) , чтобы задать следующие сведения:  
    ...
    -   Направление копирования: DB_IN из приложения в представление или таблицу или DB_OUT приложению из таблицы или представления.  
...
## <a name="example"></a>Пример  
 ...
 Выполните первый [!INCLUDE[tsql](../../../includes/tsql-md.md)] листинг кода (), чтобы создать таблицы, которые будут использоваться в образце.  
 ...
 Выполните третий [!INCLUDE[tsql](../../../includes/tsql-md.md)] листинг кода (), чтобы удалить таблицы, используемые образцом.  
