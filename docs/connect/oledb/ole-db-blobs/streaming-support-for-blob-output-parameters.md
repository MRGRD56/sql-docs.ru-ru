---
title: Поддержка потоков для выходных параметров BLOB (драйвер OLE DB)
description: Дополнительные сведения о поддержке потоковой передачи в OLE DB Driver for SQL Server для выходных параметров BLOB-объектов. В этом примере параметры BLOB-объекта привязываются в качестве интерфейсов ISequentialStream.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
author: David-Engel
ms.author: v-daenge
ms.openlocfilehash: 0563785ddc9b6121f04553582cda71b219d4ac40
ms.sourcegitcommit: 0310fdb22916df013eef86fee44e660dbf39ad21
ms.translationtype: HT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/20/2021
ms.locfileid: "104756394"
---
