...
description: OLE DB Driver for SQL Server поддерживает программную обработку истечения срока действия пароля в диалоговых окнах входа драйвера OLE DB Driver и SQL Server.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
