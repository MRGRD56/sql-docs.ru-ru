...
description: Узнайте о шифровании без проверки для соединений SQL Server. OLE DB Driver for SQL Server поддерживает шифрование без проверки.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
