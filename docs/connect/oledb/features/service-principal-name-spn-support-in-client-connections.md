...
description: Узнайте о поддержке имени субъекта-службы в клиентских подключениях в SQL Server. Просмотрите типовые сценарии использования.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
...
-   [Имена участника-службы (SPN) в клиентских соединениях (OLE DB)](../../oledb/ole-db/service-principal-names-spns-in-client-connections-ole-db.md)  
