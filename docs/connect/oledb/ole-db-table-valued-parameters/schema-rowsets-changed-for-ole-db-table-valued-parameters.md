...
description: Сведения о наборах строк схемы, измененных или добавленных для поддержки возвращающих табличные значения параметров в OLE DB Driver for SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
