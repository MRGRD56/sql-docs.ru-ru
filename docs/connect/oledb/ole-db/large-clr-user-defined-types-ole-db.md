...
description: Узнайте об изменениях в OLE DB в драйвере OLE DB Driver for SQL Server, связанных с поддержкой больших пользовательских типов данных среды CLR.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
...
[!INCLUDE[Driver_OLEDB_Download](../../../includes/driver_oledb_download.md)]
 ...
 Дополнительные сведения о поддержке больших определяемых пользователем типов данных CLR в OLE DB Driver for SQL Server см. в [этой статье](../../oledb/features/large-clr-user-defined-types.md). Пример см. в статье [об использовании больших определяемых пользователем типов CLR в OLE DB](../../oledb/ole-db-how-to/use-large-clr-udts-ole-db.md).  
