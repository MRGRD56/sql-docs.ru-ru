---
title: Получение курсора FAST_FORWARD (драйвер OLE DB)
description: Из этого примера вы узнаете, как задать свойства набора строк для получения курсора FAST_FORWARD с помощью OLE DB Driver for SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
