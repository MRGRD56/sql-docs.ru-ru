---
title: Получение столбцов с помощью IRow::GetColumns (драйвер OLE DB) | Документация Майкрософт
description: Узнайте, как извлечь столбцы с помощью метода IRow::GetColumns в OLE DB Driver for SQL Server. В этом примере показано, как получить по одному столбцу из строки за раз.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
author: David-Engel
ms.author: v-daenge
ms.openlocfilehash: a6e84293cb27027be572ff2e1f95e61cd0c9de17
ms.sourcegitcommit: 0310fdb22916df013eef86fee44e660dbf39ad21
ms.translationtype: HT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/20/2021
ms.locfileid: "104741514"
---
...
2.  Выполните команду (в следующем примере ICommandExecute::Execute() вызывается с идентификатором IID_IRow).  
...
-   Как последовательно получить группу столбцов.  
