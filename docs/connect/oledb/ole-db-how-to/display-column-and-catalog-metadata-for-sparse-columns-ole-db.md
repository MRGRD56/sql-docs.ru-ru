...
description: Из этого примера вы узнаете, как отобразить метаданные столбца и каталога для разреженных столбцов в OLE DB Driver for SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
