...
description: Из этого примера вы узнаете, как использовать OLE DB для изменения пароля учетной записи пользователя при проверке подлинности в SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
author: David-Engel
ms.author: v-daenge
ms.openlocfilehash: d2a64426fa3d1285f66be90dae8cfd2e028b4d62
ms.sourcegitcommit: 0310fdb22916df013eef86fee44e660dbf39ad21
ms.translationtype: HT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/20/2021
ms.locfileid: "104741734"
---
...
## <a name="example"></a>Пример  
 ...
 Скомпилируйте с библиотеками ole32.lib и oleaut32.lib.  
  
 Для построения этого образца потребуется учетная запись пользователя с проверкой подлинности [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] и пароль к ней. Чтобы разрешить вход с проверкой подлинности [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)], откройте среду [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Management Studio, щелкните правой кнопкой мыши узел «Сервер» в обозревателе объектов и выберите пункт «Свойства». Выберите «Безопасность» и включите режим проверки подлинности [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] и Windows. Чтобы добавить учетную запись пользователя к проверке подлинности [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)], щелкните правой кнопкой мыши узел «Безопасность» в обозревателе объектов и выберите пункт «Добавить».  
