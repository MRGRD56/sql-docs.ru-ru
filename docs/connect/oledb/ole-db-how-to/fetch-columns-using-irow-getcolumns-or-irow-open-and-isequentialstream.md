...
description: Сведения о привязке или получении больших данных с помощью интерфейса ISequentialStream в OLE DB Driver for SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
ms.locfileid: "104741474"
---
# <a name="fetch-columns-by-using-irowgetcolumns-or-irowopen-and-isequentialstream"></a>Получение столбцов с помощью метода IRow::GetColumns (или IRow::Open) и интерфейса ISequentialStream
