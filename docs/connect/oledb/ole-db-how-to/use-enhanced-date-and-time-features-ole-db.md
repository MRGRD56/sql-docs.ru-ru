---
title: Использование улучшенных функций даты и времени (драйвер OLE DB)
description: Узнайте, как использовать функции даты и времени (date, time, datetime2 и datetimeoffset) для выполнения команд и получения результатов в виде набора строк в OLE DB Driver for SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
## <a name="example"></a>Пример  
 Первый листинг кода ([!INCLUDE[tsql](../../../includes/tsql-md.md)]) создает хранимую процедуру, которая используется в примере.  
 ...
 Третий листинг кода ([!INCLUDE[tsql](../../../includes/tsql-md.md)]) удаляет хранимую процедуру, используемую в примере.  
