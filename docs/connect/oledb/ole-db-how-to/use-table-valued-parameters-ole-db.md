---
title: Использование возвращающих табличные значения параметров (драйвер OLE DB)
description: Из этого примера вы узнаете, как создавать возвращающие табличное значение параметры в OLE DB Driver for SQL Server, а также о том, как с ними работать.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
author: David-Engel
ms.author: v-daenge
ms.openlocfilehash: 694a2925a32972804665284feeef4ac7850b46be
ms.sourcegitcommit: 0310fdb22916df013eef86fee44e660dbf39ad21
ms.translationtype: HT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/20/2021
ms.locfileid: "104748774"
---
...
-   Передает строки возвращающих табличное значение параметров с помощью модели по запросу в классе EmployeesRowset. В модели получения по запросу заказчик предоставляет данные поставщику по запросу.  
  
-   Передает большие двоичные объекты как часть возвращающего табличное значение параметра в классе CPhotograph.  
