---
title: Передача данных в столбец FILESTREAM с использованием интерфейса IRowsetFastUpload (OLE DB) | Документы Майкрософт
description: Из этого примера вы узнайте, как использовать интерфейс IRowsetFastUpload для передачи данных объемом от 4 МБ до 4 ГБ в столбец FILESTREAM в OLE DB Driver for SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
author: David-Engel
ms.author: v-daenge
ms.openlocfilehash: a4d6b456d25ffa3d88c41e3afd309ddbda90607f
ms.sourcegitcommit: 0310fdb22916df013eef86fee44e660dbf39ad21
ms.translationtype: HT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/20/2021
ms.locfileid: "104741234"
---
...
## <a name="example"></a>Пример  
 ...
 Скопируйте второй листинг кода и вставьте его в файл ISSHelper.cpp.  
  
 Скопируйте третий листинг кода и вставьте его в файл IRowsetFastLoadUpload.cpp.  
  
 Скомпилируйте файлы IRowsetFastLoadUpload.cpp, ISSHelper.cpp, ole32.lib и oleaut32.lib.  
