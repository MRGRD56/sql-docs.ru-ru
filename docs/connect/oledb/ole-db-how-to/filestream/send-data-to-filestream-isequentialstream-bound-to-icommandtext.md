...
description: Сведения о том, как использовать интерфейс ISequentialStream, связанный с параметром ICommandText, для передачи от 4 МБ до 4 ГБ данных в столбец файлового потока.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
## <a name="example"></a>Пример  
 ...
 Скопируйте третий листинг кода и вставьте его в файл ICommandUpload.cpp.  
  
 Скомпилируйте файлы ICommandUpload.cpp, ISSHelper.cpp, ole32.lib и oleaut32.lib.  
