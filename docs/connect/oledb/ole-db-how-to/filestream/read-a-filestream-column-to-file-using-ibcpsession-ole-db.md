...
description: Из этого примера, вы узнайте, как считать столбец FILESTREAM в файл с помощью интерфейса IBCPSession в OLE DB Driver for SQL Server и записать файл форматирования.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
author: David-Engel
ms.author: v-daenge
ms.openlocfilehash: 02daa9e12ba3bb4f7f98fe208bf4933828e0e124
ms.sourcegitcommit: 0310fdb22916df013eef86fee44e660dbf39ad21
ms.translationtype: HT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/20/2021
ms.locfileid: "104741414"
---
...
-   [Передача данных в столбец FILESTREAM с использованием интерфейса IRowsetFastUpload &#40;OLE DB&#41;](../../../oledb/ole-db-how-to/filestream/send-data-to-a-filestream-column-using-irowsetfastupload-ole-db.md)  
 ...
 Скопируйте третий листинг кода и вставьте его в файл IBCPSession.cpp.  
  
 Скомпилируйте файлы IBCPSession.cpp, ISSHelper.cpp, ole32.lib и oleaut32.lib.  
  
 При запуске этого образца необходимо передать имя сервера (или сервер\имя_экземпляра) и имя для создаваемого файла форматирования.  
