...
description: Из этого примера вы узнаете, как запускать хранимые процедуры SQL Server с помощью RPC, а также обрабатывать коды возврата и выходные параметры.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
