---
title: Выборка данных BLOB-объектов с помощью метода IRow::GetColumns и интерфейса ISequentialStream | Документы Майкрософт
description: Эта функция извлекает данные BLOB-объекта с помощью IRow::GetColumns и ISequentialStream в OLE DB Driver for SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
