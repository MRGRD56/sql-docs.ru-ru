...
description: Текстовый конструктор запросов предназначен для ввода запроса на языке запросов, поддерживаемом источником данных, его выполнения и просмотра результатов во время разработки.
ms.date: 03/14/2017
...
### <a name="command-type-storedprocedure"></a>Тип команды StoredProcedure  
 ...
 ![Хранимая процедура в конструкторе запросов на основе текста](../../reporting-services/report-data/media/rs-relational-text-sp.gif "Хранимая процедура в конструкторе запросов на основе текста")  
