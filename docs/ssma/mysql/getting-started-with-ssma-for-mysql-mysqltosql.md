...
author: nahk-ivanov
ms.author: alexiva
ms.openlocfilehash: 6669410e8d0917560b430e2c1754871757bb7647
ms.sourcegitcommit: 295b9dfc758471ef7d238a2b0f92f93e34acbb1b
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 03/31/2021
ms.locfileid: "106054088"
---
...
|**Кнопка**|**Компонент**|  
|-|-|  
|**Создать отчет**|Преобразует выбранные объекты MySQL в SQL Server или объекты базы данных SQL Azure, а затем создает отчет, показывающий успешность преобразования.<br /><br />Эта команда отключена, если в обозревателе метаданных MySQL не выбраны объекты.|  
