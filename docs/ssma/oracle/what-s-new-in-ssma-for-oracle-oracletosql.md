...
Выпуск v 8.17 SSMA для Oracle содержит следующие изменения:

* Добавить поддержку для вычисленных столбцов
* Устранение проблем с синтаксическим анализатором при использовании символов оператора для конкретного языка и региональных параметров в выражениях
* Обновление отчетов по оценке HTML для использования современного редактора для вывода текста SQL

## <a name="ssma-v816"></a>SSMA v 8.16

Выпуск v 8.16 SSMA для Oracle содержит следующие изменения:
