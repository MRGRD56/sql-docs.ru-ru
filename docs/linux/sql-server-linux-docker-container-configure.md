...
- [Пример Dockerfile с полнотекстовым поиском](https://github.com/microsoft/mssql-docker/blob/master/linux/preview/examples/mssql-agent-fts-ha-tools/Dockerfile)
